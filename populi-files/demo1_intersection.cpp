...
int main() {
    ...
    for (const auto& test : test_rays) {
        ...
        std::cout << "  Ray origin: "; test.origin.print();
        std::cout << "  Direction: "; test.direction.print(); std::cout << "\n";
        ...
        if (discriminant < 0) {
            ...
            std::cout << "  Hit point: "; hit.print(); std::cout << "\n";
        } else {
            ...
            if (t1 > 0) {
                ...
                std::cout << "  Nearest hit: "; hit.print(); std::cout << "\n";
            }
        }
        std::cout << "\n";
    }
